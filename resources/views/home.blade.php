...
<div class="row">
    <div class="col-lg-6 col-12" style="padding-left: 0px!important;padding-right: 0px!important;">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active medicoTab" id="nav-home-tab" 
                    data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" 
                    aria-selected="true" style="padding-left: 4px;padding-right: 4px;font-size: 11px;color:black;">
                        Disponibilidade
                </a>
                <a class="nav-item nav-link medicoTab" id="nav-profile-tab" 
                    ...
                    aria-selected="false" style="padding-left: 12px;padding-right: 4px;font-size: 11px;color:red;">
                        Prioritaria
                </a>
                <a class="nav-item nav-link medicoTab" id="nav-contact-tab" 
                    ...
                    aria-selected="false" style="padding-left: 6px;padding-right: 4px;font-size: 11px;color: #1ba74c;">
                        Recorrente
                </a>
                <a class="nav-item nav-link medicoTab" id="nav-especifica"
                    ...
                    aria-selected="false" style="padding-left: 6px;padding-right: 4px;font-size: 11px;color: #2196f3;">
                    Especifica
                </a>
            </div>
        </nav>
                        ...
                        @foreach($oportunidades as $oportunidade)
                           @if($oportunidade->prioridade == 1)
                                <tr class="dados">
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-gray btnGrid" data-toggle="tooltip" data-id="{{$oportunidade->id}}" 
